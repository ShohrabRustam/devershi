...
A clean, professional portfolio website for Devarshi Kothari, Backend Software Developer specializing in backend systems, microservices, and workflow orchestration. Built with pure HTML, CSS, and JavaScript.
...
Backend Software Developer with 2.5+ years of experience building scalable, event-driven microservices in the fintech domain. Recipient of the mPokket Visionary Innovator Award. Skilled in:
- Java 21, Spring Boot, Microservices
- Apache Kafka, Event-Driven Architecture
- PostgreSQL, MySQL, Redis
- AWS (EC2, S3, Lambda, CloudWatch)
- Workflow & Saga Orchestration, System Design
- Distributed Systems, Idempotency, Dead Letter Topics
...
1. **Hero** - Introduction with key stats (2.5+ years experience, Visionary Innovator Award, ~20% infrastructure cost reduction, 250+ problems solved)
2. **About** - Professional summary and contact information
3. **Experience** - Work history at mPokket, Webveins Media, and Compsoft Technology Solutions
4. **Projects** - Key projects including:
   - Loan Restructuring Platform (orchestration across 6 systems)
...
- Visionary Innovator Award, mPokket (Q1 FY26) - for Part Payment feature and infrastructure migration
- ~20% reduction in infrastructure cost through Lift & Shift migration
